...
\curso[o]{Sistemas de Informação}
\documento[a]{Tese} % [o] para dissertação [a] para tese
\titulo{Análise e desenvolvimento de um aplicativo de auxílio de tomada de decisão na escolha de grade de horários utilizando Xamarin e Jekyll}
%\subtitulo{Subtítulo (se houver)} % Opcional
\autor{Pedro Henrique PachecoIsaac Luiz}
\grau{Graduação}
\local{Florianópolis} % Opcional (Florianópolis é o padrão)
\data{04}{junho}{2013}
\orientador[Orientador\\Universidade Federal de Santa Catarina]{Prof. Dr. Raul Sidnei Wazlawick}
